      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          <img
            ...
            alt="Workflow"
          />
          <h2 className="mt-6 text-center text-3xl font-normal text-gray-900">Signup Account</h2>
          {/* <p className="mt-2 text-center text-sm text-gray-400">
                        Enter your Username and Password
                    </p> */}
          <p className="mt-4 text-center text-sm text-gray-400">
            Already Have an Account?{' '}
            <Link to="/" className="font-medium text-gray-600  hover:text-red-600 hover:underline">
              Login
            </Link>
          </p>
        </div>
        <form className="mt-8" onSubmit={formik.handleSubmit}>
          ...
          <Dropdown
            ...
            classNames={`${getInputClasses(
              'role'
            )} inline-flex justify-between w-full rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-gray-50 text-sm font-medium ${
              formik.values.role !== '' ? 'text-gray-700' : 'text-gray-400'
