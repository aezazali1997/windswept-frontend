...
const Contact = () => {
  ...
  return (
    <div className="flex flex-col px-3 justify-center text-center content-center pt-5">
          ...
          <form className="" onSubmit={formik.handleSubmit}>
            ...
            <div
              className={`floating-input ${
                formik.touched.message && formik.errors.message ? 'mb-1' : 'mb-5'
              } relative`}>
              <textarea
                type={'text'}
                rows={5}
                ...
                id={'password'}
                name={'message'}
                className={`border border-gray-500 rounded-md ${getInputClasses(
                  formik,
                  'message'
              ...
              <div className="flex text-sm justify-between">
                ...
                <div>
                  {limit - formik.values.message.length === 0 && (
                    <p className="text-red-600">Maximum limit reached</p>
                  )}
                </div>
                <div>
                  {limit - formik.values.message.length} / {limit}
                </div>
              </div>
            </div>
            <div className="flex items-center justify-center">
              <button
                type="submit"
                className="flex items-center text-center py-2 px-4 border border-transparent text-sm font-medium text-white hover:text-red-600 hover:border-red-600  bg-red-600 hover:bg-transparent focus:outline-none ">
                Submit
                {loading && (
